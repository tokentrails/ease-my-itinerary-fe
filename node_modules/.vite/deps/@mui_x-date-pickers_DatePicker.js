import {
  ButtonBase_default
} from "./chunk-7UJS7I6J.js";
import {
  CircularProgress_default
} from "./chunk-LA5WH372.js";
import {
  Backdrop_default,
  Fade_default,
  FocusTrap_default,
...
} from "./chunk-K54BVZF2.js";
import {
  isHostComponent_default,
  resolveComponentProps_default,
  useSlot,
  useSlotProps_default
} from "./chunk-VOCWWVLX.js";
import {
  ...
  refType_default,
  useTimeout
} from "./chunk-FZ6BR3IV.js";
import {
  PickerAdapterContext,
  useThemeProps
} from "./chunk-UM7T7532.js";
import {
...
import {
  ...
  useId_default
} from "./chunk-GMJ77DLU.js";
import {
  unsupportedProp_default,
  useEventCallback_default,
  useForkRef,
  useForkRef_default
} from "./chunk-QIRUGY3L.js";
import {
  capitalize_default,
  memoTheme_default,
  useDefaultProps
} from "./chunk-ZXEMKVYS.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
function PickerPopper(inProps) {
  ...
  return (0, import_jsx_runtime5.jsx)(Popper5, _extends({}, popperProps, {
    children: ({
      TransitionProps
...
var PickersLayout = React33.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime17.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime17.jsxs)(React33.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime17.jsxs)(React33.Fragment, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime18.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime18.jsx)(Field, _extends({}, fieldProps, {
      slots,
      slotProps,
      inputRef
    })), (0, import_jsx_runtime18.jsx)(PickerPopper, {
      slots,
      slotProps,
...
var useFieldState = (parameters) => {
  ...
  const error = React35.useMemo(() => {
    if (errorProp !== void 0) {
      return errorProp;
    }
    return hasValidationError;
  }, [hasValidationError, errorProp]);
  const localizedDigits = React35.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React35.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  const getSectionsFromValue = React35.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    adapter,
  ...
  const sectionOrder = React35.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const areAllSectionsEmpty = React35.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React35.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React36.useCallback((newValue, ctx) => {
    return setValue?.(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React36.useMemo(() => {
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React38.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React38.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React39.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React39.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const domGetters = React40.useMemo(() => ({
  ...
  return (0, import_jsx_runtime20.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime20.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime20.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime20.jsxs)(React45.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime21.jsxs)(React46.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime21.jsxs)(React46.Fragment, {
  children: [(0, import_jsx_runtime21.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime21.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function PickerFieldUI(props) {
  ...
  if (!textFieldInputProps?.startAdornment && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    additionalTextFieldInputProps.startAdornment = (0, import_jsx_runtime22.jsxs)(InputAdornment3, _extends({}, startInputAdornmentProps, {
  ...
  if (!textFieldInputProps?.endAdornment && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime22.jsxs)(InputAdornment3, _extends({}, endInputAdornmentProps, {
  ...
  if (!additionalTextFieldInputProps?.endAdornment && !additionalTextFieldInputProps?.startAdornment && pickerFieldUIContext.slots.inputAdornment) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime22.jsx)(InputAdornment3, _extends({}, endInputAdornmentProps));
  }
...
true ? PickersDayRaw.propTypes = {
   ...
   * The date to show.
   */
  day: import_prop_types16.default.object.isRequired,
  /**
   ...
   * @default false
   */
  disableMargin: import_prop_types16.default.bool,
  /**
   * If `true`, the ripple effect is disabled.
   *
   * ⚠️ Without a ripple there is no styling for :focus-visible by default. Be sure
  ...
  isAnimating: import_prop_types16.default.bool,
  /**
   * If `true`, day is the first visible cell of the month.
   * Either the first day of the month or the first day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isFirstVisibleCell: import_prop_types16.default.bool.isRequired,
  /**
   * If `true`, day is the last visible cell of the month.
   * Either the last day of the month or the last day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isLastVisibleCell: import_prop_types16.default.bool.isRequired,
  onBlur: import_prop_types16.default.func,
  onDaySelect: import_prop_types16.default.func.isRequired,
   ...
   */
  outsideCurrentMonth: import_prop_types16.default.bool.isRequired,
  /**
   ...
   * @default false
   */
  today: import_prop_types16.default.bool,
  /**
...
var _excluded17 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(Dialog3, _extends({
    open,
    onClose: () => {
      dismissViews();
      onPopperExited?.();
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime39.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime39.jsx)(Field, _extends({}, fieldProps, {
      slots,
      slotProps,
      inputRef
    })), (0, import_jsx_runtime39.jsx)(PickersModalDialog, {
      slots,
      slotProps,
      children: (0, import_jsx_runtime39.jsx)(Layout, _extends({}, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
