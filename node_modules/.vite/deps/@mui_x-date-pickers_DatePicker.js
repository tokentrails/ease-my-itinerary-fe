...
} from "./chunk-B6URZ3R3.js";
import {
  PickerAdapterContext
} from "./chunk-FTYFOBQA.js";
import {
  Button_default,
  Chip_default,
...
import {
  ...
  TextField_default,
  Typography_default
} from "./chunk-OMFUQONG.js";
import {
  useThemeProps
} from "./chunk-4VBIBEHT.js";
import "./chunk-Q3G26EYF.js";
import "./chunk-ZCSSBJ3Q.js";
import {
  resolveComponentProps_default,
  useSlotProps_default
} from "./chunk-PBLWUMDR.js";
import {
  ButtonBase_default
} from "./chunk-7W4UABFE.js";
import {
  CSSTransition_default,
  TransitionGroup_default,
  refType_default,
  useTimeout
} from "./chunk-46CJNOJ6.js";
import {
...
import {
  ...
  ownerDocument,
  useControlled
} from "./chunk-D624FEFL.js";
import {
  useEventCallback_default,
  useForkRef
} from "./chunk-M6AUITSG.js";
import "./chunk-IIKQ2ZQX.js";
import {
  alpha,
  composeClasses,
...
var useControlledValue = ({
  ...
  const inputTimezone = React16.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React16.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  } = React17.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React17.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React17.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React18.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React18.useState(null);
  const popupRef = React18.useRef(null);
  const fieldRef = React18.useRef(null);
  const rootRefObject = React18.useRef(null);
  ...
  const ownerState = React18.useMemo(() => ({
  ...
  const triggerStatus = React18.useMemo(() => {
  ...
  const contextValue = React18.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React18.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React18.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React19.memo(PickersActionBarComponent);
...
var PickersLayout = React22.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime8.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime8.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime8.jsxs)(React22.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime8.jsxs)(React22.Fragment, {
...
var useFieldState = (parameters) => {
  ...
  const localizedDigits = React24.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React24.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React37.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React42.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React42.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
...
var MonthCalendarButton = React43.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
true ? MonthCalendar.propTypes = {
  ...
  currentMonth: import_prop_types7.default.object,
  /**
...
// node_modules/@mui/x-date-pickers/esm/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React52.forwardRef(function DesktopDatePicker2(inProps, ref) {
  const adapter = usePickerAdapter();
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime26.jsxs)(PickerProvider, _extends({}, providerProps, {
    children: [(0, import_jsx_runtime26.jsx)(Field, _extends({}, fieldProps, {
      slots,
      slotProps,
      inputRef
    })), (0, import_jsx_runtime26.jsx)(PickersModalDialog, {
      slots,
      slotProps,
      children: (0, import_jsx_runtime26.jsx)(Layout, _extends({}, slotProps?.layout, {
        slots,
        slotProps,
        children: renderCurrentView()
      }))
