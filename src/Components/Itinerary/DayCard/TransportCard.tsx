...
import { Clock, AlertTriangle,Plane, MapPin, Car,Bus, Bed, ShoppingBag, Activity as LucideActivity, Utensils } from "lucide-react";
...
const TimeLine = () => {
  ...
  return (
    <div className=" w-[45px] relative h-full  flex flex-col items-center">
      <div className="border-1 absolute top-3 z-100 -left-0  md:left-0 border-gray-300 shadow w-[45px] h-[45px] flex items-center justify-center rounded-[60px]" style={{ backgroundColor: '#eaf3ff' }}>
        {SelectedIcon}
      </div>
      ...
      <div className="flex-1">
        <div className="p-3  bg-white  rounded-xl">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start">
            <div className="">
              {transport.transport && transport.transport.carrier && (
                <div className="flex items-start flex-col ">
                  <p>
                    {transport.transport!.carrier}{" "}
                    {transport.transport!.service_class &&
                      transport.transport!.service_class != "N/A" && (
            ...
            {transport.transport && transport.transport.cost && transport.transport.cost != 0 ? (
          ...
          >
            <div className="flex flex-col ">
              <div className="flex items-center">
                <div className="ml-2 ">
                      ...
                      <p style={{ color: '#2093EF' }}>{moment(transport.start_time, "HH:mm").format("hh:mm a")}</p>
                </div>
              ...
              <div className="min-w-[100px]  relative min-h-[20px] mx-2">
                ...
                <div className="w-[120px] ml-3 h-[50px] border-l-2 border-dashed flex items-center  border-gray-500">
                    ...
                    <p className="text-sm font-semibold ml-2" style={{ color: '#2093EF' }}>
              ...
              <div className="flex items-center">
                <div className="ml-2 ">
                  ...
                  <p className=" text-gray-400">
                   ...
                   <p style={{ color: '#2093EF' }}>{moment(transport.end_time || "", "HH:mm").format("hh:mm a")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="">
              {transport.transport && transport.transport.notes && transport.transport.notes.length > 0 && (
                <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded">
                  <div className="flex gap-2">
                    <AlertTriangle className="w-4 h-4 mt-0.5 flex-shrink-0" color="#ef6614" />
