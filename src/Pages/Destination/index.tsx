...
const loadingMessages = [
  ...
  "Uncovering local secrets and traditions...",
  "Gathering insider tips from locals...",
  "Finding the best experiences for you...",
  "Mapping out must-visit attractions...",
  "Discovering culinary delights...",
  "Analyzing travel patterns and peak seasons...",
  "Checking upcoming events and festivals...",
  "Calculating budget estimates for your trip...",
  "Finding the perfect photo spots...",
  "Researching local transportation options...",
  "Identifying unique cultural experiences...",
  "Checking weather patterns for your visit...",
  "Finding the best accommodation areas...",
  "Compiling safety and travel tips...",
];
                      ...
                      return (
                        ...
                        >
                          <Icon
                            className="w-4 h-4"
                            style={{
                              color: activeTab === tab.id ? "white" : "#2093EF",
                            }}
                          />
                          {tab.label}
                        </ToggleButton>
              ...
              <div className="max-w-5xl mx-auto px-3 py-12">
                ...
                {activeTab === "overview" && (
                  <div className="space-y-2 animate-fadeIn">
                    ...
                    {/* Best Months */}
                    {destinationData.suggestions.best_travel_months && (
                    ...
                    {/* Upcoming Events */}
                    {destinationData.suggestions.upcoming_events && (
                      <div className="">
                  ...
                  <div className="space-y-3 animate-fadeIn">
                    ...
                    <div className="  ">
                      <div className="flex items-start gap-0">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 leading-relaxed">
                            {destinationData.topics.attractions.summary}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="">
                      ...
                      <div className="space-y-4">
                        {destinationData.topics.attractions.key_points.map(
                    ...
                    {/* Must Visit Places */}
                    {destinationData.suggestions.must_visit_attractions && (
                      <div className="">
                        <h2 className="text-xl font-medium text-gray-900 mb-6">
                          Must-Visit Spots
                        </h2>
                  ...
                  <div className="space-y-8 animate-fadeIn">
                    ...
                    <div className="">
                      <div className="flex items-start 4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 leading-relaxed">
                            {destinationData.topics.food.summary}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {destinationData.topics.food.key_points.map(
                    ...
                    <div className="mt-5">
                      ...
                      <div className="space-y-6">
                        {Object.entries(
                          ...
                          const costData = costs as CostBreakdown;
                          const widthPercent =
                            costData.max > 0
                              ? (costData.avg / costData.max) * 100
                              : 0;
                          return (
                            <div
                              key={category}
                            ...
                            >
                              ...
                              <div className="flex justify-between text-xs text-gray-500 mb-3">
                                <span>₹{costData.min} (min)</span>
                                <span>₹{costData.max} (max)</span>
                              </div>
